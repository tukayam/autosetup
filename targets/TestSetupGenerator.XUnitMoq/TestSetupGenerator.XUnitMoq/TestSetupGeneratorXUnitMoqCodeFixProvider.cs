...
namespace TestSetupGenerator.XUnitMoq
{
    ...
    public class TestSetupGeneratorXUnitMoqCodeFixProvider : CodeFixProvider
    {
        ...
        {
            get { return ImmutableArray.Create(TestSetupGeneratorXUnitMoqAnalyzer.DiagnosticId); }
        }
        ...
        private async Task<Document> CreateConstructor(Document document, ClassDeclarationSyntax classDecl, CancellationToken cancellationToken)
        {
            try
            {
                ...
                members = GetNewClassWithFieldDeclarations(generator, classUnderTest.ClassDeclarationSyntax, members);
